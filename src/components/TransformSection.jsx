  ...
  return (
    <section className="relative pb-0 overflow-visible">
      ...
      <div className="relative z-20 mt-0 md:-mt-24 lg:-mt-32 xl:-mt-40">
        <div className="red-div max-w-6xl mx-auto bg-red-800 text-white sm:rounded-3xl px-4 sm:px-6 md:px-10 pt-12 sm:pt-14 md:pt-16 shadow-2xl relative z-30 overflow-hidden">
